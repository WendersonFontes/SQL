...
FROM Person.Person
 ...
 --FAZER OPERAÇÕES MATEMÁTICAS (pode usar qualquer um +,-, / *)
...
--SOMA
 ...
 --BOOLEANOS - POR PADRÃO ELE É INICIADO COMO NULO, E PODE RECEBER TANTO 1 OU 0
 --BIT

 --CARACTERES
 --TAMANHO FIXO - CHAR // PERMITE INSERIR ATÉ UMA QUANTIDADE FIXA DE CARACTERES E SEMPRE OCUPA TODO O
 --ESPAÇO RESERVADO 10/50
 --TAMANHOS VARIÁVEIS - VACHAR OU NVARCHAR // PERMITE INSERIR ATÉ UMA QUANTIDADE QUE FOR DEFINIDA, PORÉM 
 -- SÓ USA O ESPAÇO QUE FOR PREENCHIDAO 10/50
 ...
 --NUMERIC OU DECIMAL - VALORES EXATOS, POREM PERMITE TER PARTE FRACIONADOS, QUE TAMBÉM PODE SER ESPECIFICADO
 -- A PRECISÃO E ESCALA(ESCALA É O NÚMERO DE DÍGITOS NA PARTE FRACIONAL) - EX: NUMERIC(5,2)

 ---VALORES APROXIMADOS
 --REAL - TEM PRECISÃO APROX. DE ATÉ 15 DÍGITOS
